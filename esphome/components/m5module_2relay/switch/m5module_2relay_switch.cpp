...
#include "m5module_2relay_switch.h"

namespace esphome {
namespace m5module_2relay {

static const char *const TAG = "switch.M5Module_2Relay";

float M5Module2RelaySwitch::get_setup_priority() const { return setup_priority::HARDWARE; }

void M5Module2RelaySwitch::setup() {
  ESP_LOGCONFIG(TAG, "Setting up M5Module_2Relay Switch '%s'...", this->name_.c_str());
...
void M5Module2RelaySwitch::dump_config() {
  LOG_SWITCH("", "M5Module_2Relay Switch", this);
...
void M5Module2RelaySwitch::write_state(bool state) {
...
void M5Module2RelaySwitch::set_interlock(const std::vector<Switch *> &interlock) { this->interlock_ = interlock; }
